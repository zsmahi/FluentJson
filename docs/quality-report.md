...
If a scenario is green in Newtonsoft but fails in STJ, the build fails. By maintaining this parity, we prove the abstraction is leak-proof.
...
**Our Score:**
`FluentJson.Core` achieves a perfect **100.00% Mutation Score**.
